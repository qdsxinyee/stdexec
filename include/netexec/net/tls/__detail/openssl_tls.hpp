// include/beman/net/detail/tls/openssl_tls.hpp                       -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception

#ifndef INCLUDED_INCLUDE_BEMAN_NET_DETAIL_TLS_OPENSSL_TLS
#define INCLUDED_INCLUDE_BEMAN_NET_DETAIL_TLS_OPENSSL_TLS
...
class openssl_tls_context : public context_base {
  public:
    ...
    auto create_client_session() -> std::unique_ptr<session_base> override {
        return std::make_unique<openssl_tls_session>();
    }
