...
namespace netexec {
using async_accept_t = ::netexec::detail::sender_cpo<::netexec::detail::accept_desc>;
inline constexpr async_accept_t async_accept{};

using async_connect_t = ::netexec::detail::sender_cpo<::netexec::detail::connect_desc>;
inline constexpr async_connect_t async_connect{};

using async_send_t = ::netexec::detail::sender_cpo<::netexec::detail::send_desc>;
inline constexpr async_send_t async_send{};

using async_send_to_t = ::netexec::detail::sender_cpo<::netexec::detail::send_to_desc>;
inline constexpr async_send_to_t async_send_to{};

using async_receive_t = ::netexec::detail::sender_cpo<::netexec::detail::receive_desc>;
inline constexpr async_receive_t async_receive{};
using async_receive_from_t = ::netexec::detail::sender_cpo<::netexec::detail::receive_from_desc>;
inline constexpr async_receive_from_t async_receive_from{};
} // namespace netexec

// ----------------------------------------------------------------------------

struct netexec::detail::accept_desc {
    using operation = ::netexec::detail::context_base::accept_operation;
    template <typename Acceptor>
    struct data {
        using acceptor_t           = ::std::remove_cvref_t<Acceptor>;
        using socket_t             = acceptor_t::socket_type;
        using completion_signature = stdexec::set_value_t(socket_t, typename socket_t::endpoint_type);

        acceptor_t& d_acceptor;
        data(acceptor_t& a) : d_acceptor(a) {}

        auto id() const { return this->d_acceptor.id(); }
        auto events() const { return ::netexec::event_type::in; }
...
struct netexec::detail::connect_desc {
    using operation = ::netexec::detail::context_base::connect_operation;
    ...
    struct data {
        ...
        auto events() const { return ::netexec::event_type::in_out; }
...
struct netexec::detail::send_desc {
    using operation = ::netexec::detail::context_base::send_operation;
    template <typename Stream_t, typename Buffers>
    struct data {
        using completion_signature = stdexec::set_value_t(::std::size_t);

        Stream_t& d_stream;
        Buffers   d_buffers;

        auto id() const { return this->d_stream.id(); }
        auto events() const { return ::netexec::event_type::out; }
        auto get_scheduler() { return this->d_stream.get_scheduler(); }
        auto set_value(operation& o, auto&& receiver) {
            stdexec::set_value(::std::move(receiver), ::std::move(::std::get<2>(o)));
        }
        auto submit(auto* base) -> ::netexec::detail::submit_result {
...
struct netexec::detail::send_to_desc {
    using operation = ::netexec::detail::context_base::send_operation;
    ...
    struct Data {
        ...
        auto get_scheduler() { return this->d_stream.get_scheduler(); }
        auto set_value(operation& o, auto&& receiver) {
            stdexec::set_value(::std::move(receiver), ::std::get<2>(o));
        }
        auto submit(auto* base) -> ::netexec::detail::submit_result {
            ::std::get<0>(*base).msg_iov     = this->d_buffers.data();
...
struct netexec::detail::receive_desc {
    using operation = ::netexec::detail::context_base::receive_operation;
    template <typename Stream_t, typename Buffers>
    struct data {
        using completion_signature = stdexec::set_value_t(::std::size_t);
...
struct netexec::detail::receive_from_desc {
    using operation = ::netexec::detail::context_base::receive_operation;
    template <typename Stream_t, typename Buffers, typename Endpoint>
    struct data {
        using completion_signature = stdexec::set_value_t(::std::size_t);
